...
## Project Structure
    ...
    ├── testapiautosetting_123004  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123004`
...
2. Clone this repo and `cd testapiautosetting_123004`
